...
public class PlayerController : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        if (alive)
        {
            ...
            if (boostGroundTrigger.IsTouchingLayers(ground) && boardCollider.IsTouchingLayers(ground) & !boostCheckGroundTrigger.IsTouchingLayers(ground) & !Input.GetKey(KeyCode.DownArrow))
            {
